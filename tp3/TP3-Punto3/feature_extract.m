...
original_image=image; % copia de seguridad de la imagen original
row=size(image,1);
column=size(image,2);
add_rows=0;
add_columns=0;
...
% esta imagen es punto en 11x7 pixeles, por las filas en cada zona deben ser 4, mientras que las columnas deben ser 3. 
